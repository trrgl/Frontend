...
export default function Toki() {
    ...
    return (
        <div className="w-full h-full bg-white">
            <div className="w-full h-20 bg-white fixed z-10 flex items-center justify-between px-32">
                <img onClick={() => router.push("/toki#")} src="toki_logo.png" className="h-14 cursor-pointer"></img>
