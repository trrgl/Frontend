    ...
    <div>
        <div className="w-full h-20 bg-white fixed flex items-center justify-between px-24 z-10">
            ...
            <div className="flex items-center space-x-6 w-3/5">
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Нүүр</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Үйлчилгээ</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Бидний тухай</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Үйл ажиллагаа</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Аппликэйшн</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Бүсчлэл</h1>
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf]">Коммик</h1>
            </div>
            <div className="flex items-center">
                <h1 className="cursor-pointer text-sm font-semibold text-[#695adf] mr-6">Бүртгүүлэх</h1>
                <div className="w-28 h-11 bg-[#695adf] rounded-full flex items-center justify-center font-semibold text-sm">Нэвтрэх</div>
            </div>
        </div>
        ...
        <div className="pt-20">
            <div className="w-full h-[695px] relative z-10 from-50% bg-gradient-to-l from-[#e5e7ea] to-transparent">
                ...
                <h1 className="absolute top-44 left-28 text-3xl text-black font-black">ХҮРГЭЛТИЙН<br></br> <span className="text-[#695adf]">АСУУДЛАА</span> БИДЭНД <span className="text-[#695adf]">ДААТГА</span></h1>
                <h1 className="absolute left-28 top-64 mt-4 text-lg text-black">Та дараах товч дээр дарж хүргэлтээ хаана<br></br>байгааг шалгах боломжтой.</h1>
                <div className="absolute left-28 bottom-64 w-[220px] h-[45px] bg-[#695adf] rounded-full flex items-center px-6 justify-between">
                    <h1 className="text-white text-sm font-medium">Хүргэлт шалгах</h1>
        ...
        <div className="w-full h-32 bg-white absolute bottom-0 z-10 flex justify-center">
            <div className="absolute w-[700px] -top-16 h-32 bg-white drop-shadow-lg rounded-xl flex items-center justify-between px-20">
                <div className="flex items-center">
                    ...
                    <h1 className="text-black text-sm ml-4"><span className="font-semibold text-lg">10 000+</span><br></br>Харилцагч</h1>
                </div>
                <div className="flex items-center">
                    <Image src="/map.png" width={48} height={48}/>
                    <h1 className="text-black text-sm ml-4"><span className="font-semibold text-lg">30+</span><br></br>Бүсчлэл</h1>
                </div>
                <div className="flex items-center">
                    <Image src="/send.png" width={48} height={48}/>
                    <h1 className="text-black text-sm ml-4"><span className="font-semibold text-lg">1 000+</span><br></br>Хүргэлт</h1>
                </div>
            </div>
        </div>
    </div>
