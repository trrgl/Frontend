    ...
    <div className="w-full h-[200vh] bg-[#1d1e20]">
      ...
      <section id="skills">
        <div className="w-full px-96">
          ...
          <h1 className="text-xl mt-2">- 3-4 years of HTML/CSS Experience. <br></br>- 2-3 years of C++ Experience. <br></br> - ~1 year of CTF Experience. <br></br>- Basic knowledge of JavaScript, SQL, TailwindCSS, Java, Python.</h1>
        </div>
      </section>
